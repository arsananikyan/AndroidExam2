...
public class Utils {
    ...
    public static void loadImagesFromUris(final Context context, ArrayList<Uri>  imageUris, final int requiredSize, final BitmapLoadUpdate bitmapLoadUpdate) {
        ...
        new AsyncTask<Void, Bitmap, ArrayList<Bitmap>>() {
            ...
            protected ArrayList<Bitmap> doInBackground(Void... params) {
                ...
                {
                    try {
                        Bitmap bitmap = decodeUri(context, uri, requiredSize);
            ...
            protected void onProgressUpdate(Bitmap... values) {
                bitmapLoadUpdate.onProgressUpdate(values[0]);
            }
    ...
    public interface BitmapLoadUpdate {
        void onProgressUpdate(Bitmap bitmap);
    }
